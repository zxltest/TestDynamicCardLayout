package com.zxl.dynamiccard.test.ui;
...
import com.zxl.dynamiccard.R;
import com.zxl.dynamiccard.afinal.FinalBitmap;
import com.zxl.dynamiccard.test.model.DuitangInfo;
 ...
 * 动态规划算法
 */
public class SecondAct extends Activity implements LazyScrollView.OnScrollListener {
    ...
    List<Point> lostPoint = new ArrayList<>();// 用于记录空白块的位置
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        contentTask.execute("http://www.duitang.com/album/1733789/masn/p/1/24/");
    }
    ...
    public void onBottom() {
        if (contentTask.getStatus() != AsyncTask.Status.RUNNING) {
            contentTask = new ContentTask(this);
            contentTask.execute("http://www.duitang.com/blogs/tags/hot/?page=" + currentPage
